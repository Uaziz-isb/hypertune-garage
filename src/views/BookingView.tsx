...
const APPOINTMENT_FAQS = [
  ...
  },
  {
    ...
    a: 'Absolutely. We practice 100% transparent pricing. Following our comprehensive computerized scan and physical inspection, your service advisor provides a detailed estimate for your approval via WhatsApp before any repairs or parts replacements commence.',
  },
  {
...
export const BookingView: React.FC<BookingViewProps> = ({
  ...
  // Location & Schedule State - Default: 'islamabad-g8' (HyperTune Garage - Islamabad Flagship Hub)
  const [locationId, setLocationId] = useState<string>('islamabad-g8');
  ...
  const handleSubmitBooking = async (e: React.FormEvent) => {
    ...
    const branchName =
      locationId === 'islamabad-g8'
        ? 'HyperTune Garage - Islamabad Flagship Hub'
        : 'HyperTune Garage - Rawalpindi & I-9 Branch';
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-slate-400 mt-1">
                        Dedicated service advisor assigned for your slot.
                      </p>
                    </div>
                  </div>
