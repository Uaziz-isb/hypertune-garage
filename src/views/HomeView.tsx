...
// servicesData (55KB) now loads only with this chunk, after the hero has already painted.
const ServicesGridSection = lazy(() => import('../components/ServicesGridSection').then((m) => ({ default: m.ServicesGridSection })));
import {
  Wrench,
  ShieldCheck,
  Award,
...
export const HomeView: React.FC<HomeViewProps> = ({
  ...
  return (
    <div className="space-y-20 pb-16">
      ...
      <section className="relative min-h-[85vh] flex items-center pt-28 sm:pt-32 md:pt-36 pb-12 sm:pb-16 px-3 sm:px-4 bg-slate-950 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            ...
            srcSet={currentSlide === 0 ? `${activeHero.image.replace('.jpg', '-640w.jpg')} 640w, ${activeHero.image.replace('.jpg', '-960w.jpg')} 960w, ${activeHero.image} 1280w` : undefined}
            sizes={currentSlide === 0 ? '100vw' : undefined}
      ...
      <Suspense fallback={<div className="max-w-7xl mx-auto px-4 h-96 rounded-3xl bg-[#0b121e] animate-pulse border border-slate-800" />}>
        <ServicesGridSection onNavigate={onNavigate} onOpenBooking={onOpenBooking} />
      </Suspense>
