...
import { serviceGuideMap } from '../data/guideData';
...
export const ServiceDetailView: React.FC<ServiceDetailProps> = ({
  ...
  return (
    <div className="pt-32 md:pt-36 pb-16 space-y-12">
      ...
      {/* Dedicated Service Technical Guide */}
      {(() => {
        ...
        return (
          <section className="max-w-7xl mx-auto px-4">
            <div className="bg-[#070c14] border border-cyan-500/30 rounded-3xl p-6 sm:p-8 space-y-3 shadow-xl">
              <span className="text-[11px] font-bold text-cyan-400 uppercase tracking-widest block">
                Featured Workshop Technical Guide
              </span>
              ...
              <div className="pt-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-cyan-400 border border-cyan-500/30 font-bold text-xs transition-colors"
                >
