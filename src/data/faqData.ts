...
export const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    question: 'Where are your workshop locations in Islamabad and Rawalpindi, and how do I schedule service?',
    answer: 'We operate two specialized facilities serving the Twin Cities with climate-controlled customer lounges and high-speed Wi-Fi:',
    keyHighlights: [
      'Islamabad Detailing & PPF Hub: Police Foundation (Near E-11 / PWD Link), Islamabad - Dedicated clean booths & glass coating bays',
      'Rawalpindi Mechanical Overhaul Branch: Sector I-9/3 Industrial Area - Heavy mechanical overhaul, lift bays, and alignment equipment',
      'Operating Hours: Monday – Saturday: 9:00 AM – 8:00 PM | Emergency Breakdown Towing: 24/7 Service',
    ],
    details: [
    ...
    comprehensiveOverview: `HyperTune Garage operates two state-of-the-art automotive centers conveniently located to serve vehicle owners across Islamabad, Rawalpindi, and surrounding regions. Our Islamabad Detailing & PPF Flagship Studio is situated at the Police Foundation Automotive Hub (offering quick access from Sectors E-11, F-10, F-11, PWD, and DHA). This location features pressurized dust-free clean rooms, climate-controlled infrared paint curing booths, and specialized vehicle detailing bays dedicated to Paint Protection Film (PPF), 9H Ceramic coatings, and executive interior restoration. Our second facility, the Rawalpindi Mechanical Overhaul & Diagnostics Branch, is located in Sector I-9/3 Industrial Area, perfectly positioned for commuters from Rawalpindi Saddar, Cantt, Westridge, and Islamabad I-8/I-9. This heavy mechanical hub houses multiple 4-post hydraulic lifts, 3D laser wheel alignment racks, automatic transmission flush machinery, and our dust-free clean engine rebuild laboratory. Both locations operate from Monday through Saturday between 9:00 AM and 8:00 PM, with 24/7 flatbed emergency towing services available. Scheduling a service appointment is quick and seamless: you can utilize the interactive online booking tool here on our website, call our central customer helpline, or connect directly via WhatsApp. Booking an appointment in advance guarantees zero waiting time upon arrival, as a dedicated service bay and master technician are pre-assigned to your vehicle prior to your entry. While your vehicle is being inspected or serviced, you are invited to relax in our executive air-conditioned customer lounge, equipped with complimentary gourmet espresso, high-speed fiber Wi-Fi, private workstation desks, and live HD video monitors broadcasting real-time feeds from your vehicle's work bay. We accept all payment options including cash, major credit/debit cards (Visa, MasterCard, PayPak), online direct bank transfers, and corporate fleet billing accounts.`,
  },
  {
    id: 'faq-9',
    category: 'General & Booking',
    question: 'Do you offer covered flatbed towing and executive vehicle pick-up/drop-off service in Islamabad & Rawalpindi?',
    answer: 'Yes! We provide safe, fully insured vehicle transport and valet pick-up services across all sectors of Islamabad and Rawalpindi:',
    keyHighlights: [
      'Covered Hydraulic Flatbed Towing: Ideal for low-clearance vehicles, sedans, SUVs, and non-drivable breakdown vehicles',
      'GPS-Tracked Executive Pick-Up: Uniformed, background-checked drivers pick up your vehicle directly from your home or office',
      'Coverage Sectors: Islamabad (F-6, F-7, F-8, F-10, F-11, G-11, E-11, DHA Phase 1-5, Bahria Town) and Rawalpindi (Saddar, Cantt, Chaklala, Westridge)',
    ],
    details: [
      'Flatbed Safety Standards: Our flatbed tow trucks feature hydraulic low-angle tilt beds specifically designed to transport vehicles safely without scraping front splitters or bumpers.',
      ...
      'Drop-off Delivery: Once servicing or PPF application is complete, your vehicle undergoes a final QA inspection, detailing wipe-down, and is delivered back to your doorstep.',
    ],
    comprehensiveOverview: `Yes, HyperTune Garage provides premium, fully insured flatbed towing and executive concierge vehicle pick-up and drop-off services across all residential and commercial sectors of Islamabad and Rawalpindi. Transporting sedans, SUVs, sports cars, or non-drivable breakdown vehicles requires specialized transport equipment. Standard wheel-lift tow trucks can inflict severe damage on automatic transmissions, low-slung front splitters, and electronic parking brakes. To eliminate these risks, HyperTune Garage operates specialized hydraulic low-angle flatbed tow trucks engineered specifically for vehicle safety. The flatbed deck lowers completely flat to the ground, allowing cars to be safely winched aboard without scraping front bumpers, side skirts, or underbody splash guards. For routine maintenance, PPF application, or scheduled repairs where your vehicle is drivable, we offer our Executive Concierge Valet Service. A uniformed, background-checked, and fully insured HyperTune professional driver will pick up your vehicle directly from your residence, office, or embassy anywhere in Islamabad (F-6, F-7, F-8, F-10, F-11, G-11, E-11, Diplomatic Enclave, DHA Phases 1–5, Bahria Town) or Rawalpindi (Saddar, Cantt, Chaklala Scheme 3, Westridge). Upon arrival at your location, our driver conducts a comprehensive digital 360-degree intake walkaround, logging odometer readings, fuel levels, and existing exterior conditions into a digital report sent instantly to your phone. Throughout transit and workshop servicing, your vehicle is fully covered under our garage transit insurance policy. Once all servicing, quality assurance testing, and final detailing cleanups are finalized, your vehicle is delivered back to your specified location in spotless, road-ready condition.`,
  },
];
