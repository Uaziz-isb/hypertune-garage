...
export const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Our active Flagship Hub is located in Islamabad, and our new Rawalpindi Hub is currently under development:',
    keyHighlights: [
      ...
      'HyperTune Garage - Rawalpindi Hub (Opening Soon): Currently under development. Stay tuned for the official opening announcement',
    ...
    comprehensiveOverview: `HyperTune Garage provides premium automotive care and computerized diagnostics for vehicle owners across Islamabad and Rawalpindi. Our fully operational Islamabad Flagship Studio is situated at the Police Foundation Automotive Hub (offering quick access from Sectors E-11, F-10, F-11, PWD, and DHA). This location features pressurized dust-free clean rooms, climate-controlled infrared paint curing booths, and specialized vehicle detailing bays dedicated to Paint Protection Film (PPF), 9H Ceramic coatings, and executive vehicle maintenance. Our second facility, HyperTune Garage - Rawalpindi Hub, is currently under development and will be opening soon to serve Rawalpindi with world-class facilities. In the meantime, all bookings and inquiries are serviced at our Islamabad Flagship Hub. Scheduling an appointment is quick: you can utilize the online booking tool, call 0333-0177717, or connect via WhatsApp.`,
  },
  {
    id: 'faq-9',
    category: 'General & Booking',
