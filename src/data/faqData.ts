...
export const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    keyHighlights: [
      ...
      'Operating Hours: Saturday – Thursday: 10:00 AM – 10:00 PM | Friday: CLOSED (Weekly Holiday)',
    ],
    details: [
