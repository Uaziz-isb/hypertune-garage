...
export const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    keyHighlights: [
      'Covered Concierge Flatbed Transport: Ideal for low-clearance sports cars, sedans, luxury SUVs, and maintenance transit',
    ...
    details: [
      'Flatbed Safety Standards: Our dedicated transport trucks feature hydraulic low-angle tilt beds specifically engineered to transport vehicles safely without scraping front splitters or bumpers.',
