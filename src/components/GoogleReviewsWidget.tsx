...
export const initialGoogleBusinessData: GoogleBusinessData = {
...
export const GoogleReviewsWidget: React.FC<GoogleReviewsWidgetProps> = ({
  ...
  // Initialize with verified data so rendering is instant with 0ms network blocking
  const [data, setData] = useState<GoogleBusinessData>(initialGoogleBusinessData);
