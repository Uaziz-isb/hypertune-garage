    ...
    try {
      ...
      const res = await fetch('/api/booking', {
        ...
        body: JSON.stringify({
          ...
          vehicleModel: model,
          year,
          location: locationId === 'islamabad-g8' ? 'Islamabad Flagship Hub (Police Foundation)' : 'Rawalpindi Hub (Opening Soon)',
